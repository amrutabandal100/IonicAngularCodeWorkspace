...
/*GetData(){ 
  let locationsCollection = this.afs.collection(
    `locations/ZxzJY8blo7bGOyhX8gxd3vu25i32/track`,
    ref => ref.orderBy('timestamp')
  );
  console.log("................locatin........",locationsCollection);
  //locationsCollection.get().forEach((value) => {
  //  console.log("vishal", value);
  //});
  let dataread=locationsCollection.snapshotChanges()
